function [READN,READT,WINDOWN,WINDOWT,RATIOS] = map_alignable_reads_v2( sampleinfo, tumorName, alignableDir, windowFile, minNormalCount, medianCenter, germlineCNV, removeCNV, chrLengthFile, calcRatios )
%------------------------------------------------------------------------%
...
ratiofile = [ tumorName '_alignable_ratios.txt' ];

% Determine the number of chromosomes
fid=fopen(chrLengthFile);
if fid == -1
    error(['ERROR: Cannot open chromosomal information file ' chrLengthFile]);
end
...
%%---  SAVE OUTPUT  ---%
save(matfile,'READN','READT','RATIOS','WINDOWN','WINDOWT','sampleNames','-v7.3');
